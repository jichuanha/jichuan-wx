...
<div style="position: relative">
    ...
    <input type="text" id="${name}" name="${name}" maxlength="5" class="txt required input-block-level form-control" style="font-weight:bold;width:100%;display: block;${inputCssStyle}"/>
</div>
