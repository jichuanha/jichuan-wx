...
$.jgrid.extend({
	pivotSetup : function( data, options ){
		...
		this.each(function(){
			...
			//tree = { text: 'root', zj: false, children: [] };
		...
		return this.each(function(){
			...
			while(i<len) {
				...
				if(ldat[isLeaf] === "true" || ldat[isLeaf] === true) {
					twrap += ((ldat[icon] !== undefined && ldat[icon] !== "") ? ldat[icon] : $t.p.treeIcons.leaf)+" tree-zj treeclick";
					ldat[isLeaf] = true;
					lf="leaf";
				} else {
					ldat[isLeaf] = false;
			...
			if ( parentid === undefined  || parentid === null || parentid==="") {
				...
				if(parentdata[isLeaf]) {
					...
					$($t.rows[prow])
						...
						.end()
						.find("div.tree-zj").removeClass($t.p.treeIcons.leaf+" tree-zj").addClass($t.p.treeIcons.minus+" tree-minus");
