...
/***/ function(module, exports) {
	...
	module.exports = {
		"static_path": "http://192.168.8.120:3000",
		"api_path": ""
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var self_tpl = __webpack_require__(5);
	var api_path = __webpack_require__(3).api_path;
	var eventObj = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../module/time-purchase/evnet.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	$(function(){
		//商品弹窗
		var goodsFilter = {
			brand_key: '',
		...
		function getGoodsList() {
			$.get('/bossmanager/item/query333.do', 
				{
					key: goodsFilter.key,
		...
		function bindEvent() {
			...
			$('#save-selected-btn').click(function(){
				...
				// var campaign_limit_price = $('.parent-table .limit-price').val().trim();
				// if(campaign_limit_price === ''){
				// 	layer.msg('请填写活动售价');
				// 	return;
				// };
				var campaignInfo = {
