        ...
        initUploader: function () {
            ...
            function updateStatus() {
                ...
                if (state === 'ready') {
                    ...
                    if (stats.uploadFailNum || uploader.$uploadFailNum) {
                        text += lang.updateStatusError.replace('_', stats.uploadFailNum || uploader.$uploadFailNum);
                    }
                }
                $info.html(text);
            }
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        this.request("get-stats").numOfSuccess && this.request("get-stats").numOfSuccess--;
                        if(typeof this.$uploadFailNum === "undefined"){
                            this.$uploadFailNum = 0;
                        }
                        this.$uploadFailNum++;
                        $file.find('.error').text(json.state|| "上传失败,请重试!").show();
                    }
                } catch (e) {
                    this.request("get-stats").numOfSuccess && this.request("get-stats").numOfSuccess--;
                    if(typeof this.$uploadFailNum === "undefined"){
