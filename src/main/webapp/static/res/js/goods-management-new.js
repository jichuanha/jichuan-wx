$(function() {
        ...
        $.get('/bossmanager/item/query.do', {
            ...
            function(data) {
                ...
                $(data.data.data).each(function(k, value) {
                 ...
                 $render.html(doT.template(self_tpl.j_template_goods)({
    ...
    function bindEvent() {
        ...
        function rendExtendTbody(spuId, goodId) {
            $.get('/bossmanager/item/sku/queryx.do', {
                ...
                function(data) {
                    $("#" + goodId).html(doT.template(self_tpl.j_template_sku)(data.data.skus));
                }
            );
        }
    ...
    $('#session-wrap').html(doT.template(self_tpl.j_template_session)());
	// 删除子场
	$(".form-horizontal").on('click',".btn-dele",function(event){
		$(event.target).parents('.per-session').remove();
	});
	...
	$("#choose-categary").on("click",function(){
		...
		$.get('/getGoodsCategary.do',
			...
			function(data){
                $('#select-goods-categary .left').html(doT.template(self_tpl.j_template_categary)(data.data));
                $('#select-goods-categary .right').html(doT.template(self_tpl.j_template_categary)(data.data));
    ...
    function getImgList(currentPage, pageSize) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#j-img-select-box').html(doT.template(self_tpl.img_select_template)(data.data.list));
            }
        });
    }
